...
<template>
  <div style="text-align: center">
    ...
    <el-button size="small" @click="deleteSelectedFeaturesAnimation()">删除动画</el-button>
    <el-button size="small" @click="deleteAllAnimation()">删除全部动画</el-button>
