export default () => {
  ...
  function onload() {
    'use strict'
    var host = document.location.protocol + '//www.supermapol.com'
    // viewer = Cesium.Viewer('SuperMap3DContainer')
    // viewer = new Cesium.Viewer('SuperMap3DContainer')
    scene = viewer.scene
    // scene.lightSource.ambientLightColor = Cesium.Color(0.65, 0.65, 0.65, 1)
    serverUrl = host + '/realspace/services/plot-TY/rest/plot'
  ...
  function InitPlot(viewer, serverUrl) {
    ...
    const plotEditControl = new SuperMap3D.PlotEditControl(scene, plottingLayer)// 编辑控件
  ...
  function createAnimation() {
    ...
    plottingLayer.createSymbol(22, 1004, pointsJGSZ, function (even) {
      ...
      var goAnimationJGSZ = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_GROW, 'JGSZ', geoJGSZ)// 进攻警力生长动画
      goAnimationJGSZ.startTime = 0// 动画开始时间
      goAnimationJGSZ.duration = 5// 动画播放时长
    })

    var pointsTFXS = []
    pointsTFXS[0] = new SuperMap3D.PlotPoint3D(13.0523705219875, 47.828610443775, 0)
    pointsTFXS[1] = new SuperMap3D.PlotPoint3D(13.0528881926318, 47.8282317961645, 0)
    pointsTFXS = MoveSymbol(pointsTFXS)
    plottingLayer.createSymbol(22, 1003, pointsTFXS, function (even) {
      geoTFXS = even.feature
      geoTFXS.symbolStyle.lineColor = new SuperMap3D.Color(1, 1, 0, 1)// "#ffff00"
      var goAnimationTFXS = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_SHOW, 'TFXS1', geoTFXS)// 逃犯显隐动画
      ...
      var goAnimationTFXS1 = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_GROW, 'TFSZ1', geoTFXS)// 逃犯生长动画
    ...
    var pointsLJXS = []
    pointsLJXS[0] = new SuperMap3D.PlotPoint3D(13.0534667673921, 47.8270362098687, 0)
    pointsLJXS[1] = new SuperMap3D.PlotPoint3D(13.0538011154244, 47.827160636473, 0)
    pointsLJXS[2] = new SuperMap3D.PlotPoint3D(13.0536234845445, 47.8277084980454, 0)
    pointsLJXS[3] = new SuperMap3D.PlotPoint3D(13.0527838234958, 47.8283098940719, 0)
    pointsLJXS = MoveSymbol(pointsLJXS)
    plottingLayer.createSymbol(421, 311, pointsLJXS, function (even) {
      geoLJXS = even.feature
      var goAnimationLJXZ = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_SHOW, 'LJXZ', geoLJXS)// 拦截警力显隐动画
      goAnimationLJXZ.showEffect = false
      goAnimationLJXZ.finalDisplay = true
      goAnimationLJXZ.startTime = 0
      goAnimationLJXZ.duration = 6

      var goAnimationLJXZ1 = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_GROW, 'LJXZ1', geoLJXS)// 拦截警力生长动画
      goAnimationLJXZ1.startTime = 5
      goAnimationLJXZ1.duration = 6
    })

    var pointsTFXS2 = []
    pointsTFXS2[0] = new SuperMap3D.PlotPoint3D(13.0523210258708, 47.8288491462176, 0)
    pointsTFXS2[1] = new SuperMap3D.PlotPoint3D(13.0529279851615, 47.8293174019239, 0)
    pointsTFXS2 = MoveSymbol(pointsTFXS2)
    plottingLayer.createSymbol(22, 1003, pointsTFXS2, function (even) {
      geoTFXS2 = even.feature
      geoTFXS2.symbolStyle.lineColor = SuperMap3D.Color(1, 1, 0, 1)// "#ffff00"
      var goAnimationTFXS2 = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_SHOW, 'TFXS2', geoTFXS2)// 逃犯显隐动画
      ...
      var goAnimationTFSZ2 = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_GROW, 'TFSZ2', geoTFXS2)// 逃犯生长动画
    ...
    var pointsZYSS = []
    pointsZYSS[0] = new SuperMap3D.PlotPoint3D(13.0542650683879, 47.8287131454005, 0)
    ...
    plottingLayer.createSymbol(421, 80101, pointsZYSS, function (even) {
      ...
      var goAnimationZYSS = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_BLINK, 'ZYSS', geoZYSS)// 支援警力闪烁动画
      goAnimationZYSS.blinkStyle = SuperMap3D.BlinkAnimationBlinkStyle.Blink_Frequency// 闪烁类型，频率闪烁
      goAnimationZYSS.replaceStyle = SuperMap3D.BlinkAnimationReplaceStyle.Replace_Color// 颜色交替类型
      goAnimationZYSS.startColor = SuperMap3D.Color(0, 0, 1, 1) // 开始颜色，默认为蓝色
      goAnimationZYSS.endColor = SuperMap3D.Color(1, 0, 0, 1) // 结束颜色，默认为红色
      goAnimationZYSS.startTime = 14
      goAnimationZYSS.duration = 3
    })

    var pointsLJZY = []
    pointsLJZY[0] = new SuperMap3D.PlotPoint3D(13.0532740180585, 47.829706145191, 0)
    ...
    plottingLayer.createSymbol(421, 80202, pointsLJZY, function (even) {
      ...
      var goAnimationJGZY = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_BLINK, 'JGZY', geoLJZY)// 拦截车闪烁动画
      goAnimationJGZY.blinkStyle = SuperMap3D.BlinkAnimationBlinkStyle.Blink_Frequency
      goAnimationJGZY.replaceStyle = SuperMap3D.BlinkAnimationReplaceStyle.Replace_Color
      goAnimationJGZY.startTime = 14
      goAnimationJGZY.duration = 3
    })

    var pointsZYSS2 = []
    pointsZYSS2[0] = new SuperMap3D.PlotPoint3D(13.0520708307129, 47.8299387619131, 0)
    ...
    plottingLayer.createSymbol(421, 80101, pointsZYSS2, function (even) {
      ...
      var goAnimationZYSS2 = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_BLINK, 'ZYSS2', geoZYSS2)// 支援警力闪烁动画
      goAnimationZYSS2.blinkStyle = SuperMap3D.BlinkAnimationBlinkStyle.Blink_Frequency
      goAnimationZYSS2.replaceStyle = SuperMap3D.BlinkAnimationReplaceStyle.Replace_Color
      goAnimationZYSS2.startTime = 14
      goAnimationZYSS2.duration = 3
    })

    var pointsJC = []
    pointsJC[0] = new SuperMap3D.PlotPoint3D(13.0523196095789, 47.8276819225323, 0)
    ...
    plottingLayer.createSymbol(421, 50, pointsJC, function (even) {
      ...
      var goAnimationJC = animationManager.createGOAnimation(SuperMap3D.GOAnimationType.ANIMATION_SCALE, 'JC', geoJC)
    ...
    plottingLayer.createSymbol(421, 20100, pointsSJ, function (even) {
      geoSJ = even.feature
      geoSJ.symbolStyle.lineColor = SuperMap3D.Color(1, 1, 0, 1)
      geoSJ.textContent = '事件'
    })

    var pointsLJJL = []
    pointsLJJL[0] = new SuperMap3D.PlotPoint3D(13.053414647609, 47.8268751538344, 0)
    ...
    var pointsJGJL = []
    pointsJGJL[0] = new SuperMap3D.PlotPoint3D(13.0485470948225, 47.8271255667932, 0)
  ...
  function deleteSelectedFeaturesAnimation() {
    if (animationManager.getAllAnimations().length === 0) {
      return
    }
